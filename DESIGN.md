...
- **v0.8.0 cut** (2026-07-24, median of 3): `/` **~91%**; `/json` **~89%**; post-GC RSS **~0.93×** — see [docs/PERF.md](docs/PERF.md). Barriers / TLAB / blacklist / atfork / aarch64 / metrics; thr gate (≥95%) still open on Kemal `/json`.
- **v0.9.0 cut** (2026-07-24, median of 3): `/` **~89%**; `/json` **~92%**; post-GC RSS **~0.97×** — see [docs/PERF.md](docs/PERF.md). Stack scrub (opt-in), process parallel-mark (experimental), richer observability; thr gate (≥95%) still open on Kemal `/json`.
...
- acikturkiye `/api/v1/` **v0.8.0** (2026-07-24, median of 3): thr **~95%**; **post-GC RSS ~3.2×** — see [docs/ACIKTURKIYE.md](docs/ACIKTURKIYE.md).
- acikturkiye `/api/v1/` **v0.9.0** (2026-07-24, median of 3): thr trial-median **~93%**; **post-GC RSS ~2.84×** — see [docs/ACIKTURKIYE.md](docs/ACIKTURKIYE.md).
