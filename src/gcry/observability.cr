  ...
  module Observability
    ...
    def self.json_stats(heap : Heap = Gcry.default_heap) : String
      ...
      )
      {
        ...
        tlab_hit_attr_find_block_ns:           heap.tlab_hit_attr_find_block_ns,
        tlab_hit_attr_find_block_calls:        heap.tlab_hit_attr_find_block_calls,
        tlab_hit_attr_refill_ns:               heap.tlab_hit_attr_refill_ns,
        tlab_hit_attr_refill_calls:            heap.tlab_hit_attr_refill_calls,
