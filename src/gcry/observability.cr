  ...
  module Observability
    ...
    def self.json_stats(heap : Heap = Gcry.default_heap) : String
      ...
      )
      {
        ...
        cursor_word_advances:        heap.cursor_word_advances,
        fast_miss_collecting:        heap.fast_miss_collecting,
        fast_miss_size:              heap.fast_miss_size,
        fast_miss_no_set:            heap.fast_miss_no_set,
        fast_miss_refill:            heap.fast_miss_refill,
        fast_miss_threshold:         heap.fast_miss_threshold,
        radix_fast_hits:             heap.radix_fast_hits,
        radix_slow_lookups:          heap.radix_slow_lookups,
        radix_owned_hits:            heap.radix_owned_hits,
        ...
        cursor_sets_retired:         heap.cursor_sets_retired,
        gc_threshold:                heap.gc_threshold,
        adaptive_threshold:          heap.adaptive_threshold,
        bitmap_alloc:                heap.bitmap_alloc?,
        alloc_fast_path:             heap.fast_path?,
        ...
        root_phase_timing:           heap.root_phase_timing,
        roots_explicit_ns:           heap.last_roots_explicit_ns,
        roots_cursors_ns:            heap.last_roots_cursors_ns,
        roots_metadata_ns:           heap.last_roots_metadata_ns,
        roots_fibers_ns:             heap.last_roots_fibers_ns,
        roots_threads_ns:            heap.last_roots_threads_ns,
        ...
        static_root_overflow:        Platform.static_root_overflow,
        ...
        fiber_scan_from_sp:                    heap.fiber_scan_from_sp,
        fiber_scan_from_guard:                 heap.fiber_scan_from_guard,
        fiber_scan_running_stale:              heap.fiber_scan_running_stale,
        ...
        chunk_index_only_bytes:                heap.chunk_index_only_bytes,
        ...
        mark_audit_dying_edges:                heap.mark_audit_dying_edges,
        ...
        thread_birth_overflows:                Gcry::ThreadBirthRoot.overflows,
        ...
        stw_suspend_abandoned:                 heap.stw_suspend_abandoned,
        stw_suspend_stale_signals:             heap.stw_suspend_stale_signals,
        ...
        release_holders_searches:              heap.release_holders_searches,
        release_live_holders:                  heap.release_live_holders,
        release_live_frame_holders:            heap.release_live_frame_holders,
