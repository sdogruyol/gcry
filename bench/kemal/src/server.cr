...
{% if flag?(:gc_none) %}
  get "/gc-stats" do |env|
    ...
    s = GC.stats
    {
      ...
      layout_precise_scans:      h.layout_precise_scans,
      layout_conservative_scans: h.layout_conservative_scans,
      layout_entries:            Gcry::Layout.size,
      type_id_root_rejects:      h.type_id_root_rejects,
      sp_clamp_hits:             h.sp_clamp_hits,
