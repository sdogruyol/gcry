...
`../2026-09-04-alloc-fast-path/` (`trials.jsonl`, `analysis.txt`): with the
cursor sets, headerless `/json` is **106.7% of Boehm** (paired, 95% CI
[102.2, 111.2], t = 3.02, n = 20) at 0.97× its peak RSS and 14% less CPU
per request, over the heap policy's 100.9% [96.8, 105.1].
