...
JOBS = [
    ...
    ("mt_prop", lambda s: [f"{C}/mt_prop", f"--seed={s}", "--iterations=500", "--workers=2,4,8"], {}, 300),
...
def lane(n):
    while time.time() < DEADLINE:
        ...
        with open(log, "w") as f:
            p = subprocess.Popen(argv(seed), env={**os.environ, **env}, stdout=f, stderr=subprocess.STDOUT,
