...
arms=[("ec1+t1 default",f"{G}/kemal-ec1-fix",{"EXTRA_THREADS":"1"}),
      ("ec1+t1 DORMANT=1",f"{G}/kemal-ec1-fix",{"EXTRA_THREADS":"1","GCRY_PARALLEL_DORMANT":"1"}),
      ("ec1+t1 DORMANT=1 RETAIN=64M",f"{G}/kemal-ec1-fix",{"EXTRA_THREADS":"1","GCRY_PARALLEL_DORMANT":"1","GCRY_EMPTY_CHUNK_RETAIN":str(64<<20)}),
      ("ec4 default",f"{G}/kemal-gcry-mt",{"EC_PARALLELISM":"4"}),
      ("ec4 DORMANT=1",f"{G}/kemal-gcry-mt",{"EC_PARALLELISM":"4","GCRY_PARALLEL_DORMANT":"1"}),
      ("ec4 DORMANT=1 RETAIN=64M",f"{G}/kemal-gcry-mt",{"EC_PARALLELISM":"4","GCRY_PARALLEL_DORMANT":"1","GCRY_EMPTY_CHUNK_RETAIN":str(64<<20)})]
