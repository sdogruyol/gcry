...
|---|---|---|---|---|---|---|---|
| unreleased |  | 5 | 104.4 [96.9–105.1] | 99.2 [97.1–100.8] | 0.97 [0.96–1.05] | 0.59 [0.40–0.72] | headerless |
...
| release | date | runs | `/json` % of Boehm | `/` % of Boehm | peak RSS × Boehm | pause p50 ms | layout |
|---|---|---|---|---|---|---|---|
| unreleased |  | 5 | 109.1 [92.2–119.2] | 97.6 [66.2–103.3] | 1.13 [1.10–1.17] | 0.50 [0.46–0.51] | headerless |
...
402 runs listed, 5 on commits no longer on master.
